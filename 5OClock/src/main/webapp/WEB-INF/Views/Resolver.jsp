...
function getResolved(xhr){
	...
	for(x in res){
		table.innerHTML += "<tr><td>"+res[x].type+"</td><td>"+res[x].description+"</td><td>"+res[x].price+"</td><td>"+res[x].startTime+"</td><td>"+res[x].endTime+"</td><td>"+res[x].status+"</td><td>"+res[x].venue.venueName+"</td><td>"+res[x].venue.address+"</td></tr>";
	}
}
